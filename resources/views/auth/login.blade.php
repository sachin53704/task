                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="card2 card border-0 px-4 py-5">
                                <div class="row px-3">
                                    ...
                                    @enderror
                                    <input class="mb-4 @error('email') is-invalid @enderror" type="email" name="email" placeholder="Enter a valid email address"  id="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                </div>
                                <div class="row px-3">
                                    <label class="mb-1">
                                ...
                                <div class="row px-3 mt-2 mb-4">
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        ...
                                        <label for="remember" class="custom-control-label text-sm">
                                            Remember me
                                        </label>
                                    </div>
